 ...
 * rect.js
 *
 * Rect is a simple data structure for representation of a
 * rectangle supporting many basic geometric operations.
 *
 * NOTE: Since its operations are closed, rectangles may be empty and will report
 * non-positive widths and heights in that case.
 */
  
define(['js/popups/geometry/point'], function(Point) {
